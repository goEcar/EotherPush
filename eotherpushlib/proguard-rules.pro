...
-dontwarn com.ecar.epark.eproviderlib.provider.**
-keep class com.ecar.epark.eproviderlib.provider.** {*;}
-dontwarn com.ecar.pushlib.provider.**
-keep class com.ecar.pushlib.provider.** {*;}
